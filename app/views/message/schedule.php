          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="<?= BASEURL; ?>message/outbox"><i class="fa fa-envelope-o"></i> Sent</a></li>
                <li><a href="#"><i class="fa fa-file-text-o"></i> Drafts</a></li>
                <li  class="active"><a href="<?= BASEURL; ?>message/schedule"><i class="fa fa-filter"></i> Schedule 
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <thead>
                    <tr>
                      ...
                      <th width="20%" style="vertical-align: middle; text-align: center">Schedule</th>
                      <th style="text-align: center">Message</th>
                      <th width="10% style="text-align: center">Count</th>
                      <th width="15% style="text-align: center">Footer</th>
